...
describe('Given I am connected as an Admin', () => {
  ...
  describe('When I am on Dashboard page and I click on arrow', () => {
    ...
    // Then when ckiking again, the tickets list should be folding, and cards should disappear 165-167 
    test('Then, tickets list should be folding, and cards should disappear', async () => {
      ...
      // First click to unfold
      icon1.addEventListener('click', handleShowTickets1)
      userEvent.click(icon1)
      expect(handleShowTickets1).toHaveBeenCalled()
      await waitFor(() => screen.getByTestId(`open-bill47qAXb6fIm2zOKkLzMro`) )
      expect(screen.getByTestId(`open-bill47qAXb6fIm2zOKkLzMro`)).toBeTruthy()
      // Second click to fold
      userEvent.click(icon1)
      ...
      // Second click to fold
      userEvent.click(icon2)
      expect(screen.queryByTestId(`open-billUIUZtnPQvnbFnB0ozvJh`)).toBeNull()
      ...
      // Second click to fold
      userEvent.click(icon3)
      expect(screen.queryByTestId(`open-billBeKy5Mo4jkmdfPGYpTxZ`)).toBeNull()

      // Check that the icons have the correct rotation style
